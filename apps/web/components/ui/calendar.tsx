    ...
    <DayPicker
      ...
      classNames={{
        ...
        month_caption: cn(
          ...
          'flex items-center justify-center pt-1 relative h-9',
        ),
        caption_label: cn(
          defaults.caption_label,
          'text-[14px] font-medium text-foreground tracking-[-0.1px]',
        ),
        ...
        weekday: cn(
          defaults.weekday,
          'flex-1 text-muted-foreground text-[11px] font-medium uppercase tracking-[0.1em] py-2',
        ),
      ...
      components={{
        Chevron: ({ orientation }) =>
          orientation === 'left' ? <CaretLeftIcon size={14} /> : <CaretRightIcon size={14} />,
      }}
      {...props}
    />
  );
