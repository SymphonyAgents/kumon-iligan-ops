  ...
  return (
    ...
    >
      <DialogContent className="max-w-sm">
        <DialogHeader>
          <DialogTitle>
            Assign Teacher — {fullName(student?.firstName, student?.lastName)}
          </DialogTitle>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-2">
          <div className="flex flex-col gap-1.5">
    ...
    <div>
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description={
            statusFilter === STUDENT_STATUS.ACTIVE
              ? 'No active students. Enroll one using the button above.'
                    ...
                    <button
                      onClick={() =>
                        changeStatusMut.mutate({
                          id: s.id,
                          data: { status: STUDENT_STATUS.INACTIVE },
                        })
                      }
                  ...
                  {s.status === STUDENT_STATUS.INACTIVE && (
                    <button
                      onClick={() =>
                        changeStatusMut.mutate({
                          id: s.id,
                          data: { status: STUDENT_STATUS.ACTIVE },
                        })
                      }
