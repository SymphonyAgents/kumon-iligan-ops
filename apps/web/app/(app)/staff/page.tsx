...
function StaffContent() {
 ...
 onBranchChange: isSuperadmin ? (id, newBranchId, currentBranchId, email, newBranchName, currentBranchName) => {
 ...
 <p className="text-xs text-muted-foreground mt-0.5">User management is only available to admins.</p>
 </div>
 </div>
 );
 }
 ...
 <p className="text-xs text-muted-foreground/60 mt-1">New signups will appear here for review.</p>
 </div>
 ) : (
 <DataTable
 columns={columns}
