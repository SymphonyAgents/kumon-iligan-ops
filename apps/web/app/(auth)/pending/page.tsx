        ...
        {isRejected ? (
          <>
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground">
                Your account request has been declined. If you believe this is a mistake, contact
                your administrator.
              </p>
            </div>
          </>
          ...
          <>
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground">
                Your account is awaiting approval from an administrator. You&apos;ll be able to sign
                in once approved.
              </p>
            </div>
          </>
